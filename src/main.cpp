...
int main()
{
    ...
    glAttachShader(shaderProgram, vertexShader);
    glAttachShader(shaderProgram2, secondFragmentShader);
    ...
    // ------------------------------------------------------------------
    float vertices[] = {
        -0.25f, -0.25f, 0.0f, // left1  
         0.25f, -0.25f, 0.0f, // right1 
         0.0f,  0.25f, 0.0f,  // top1
    };
    float vertices2[] =
    {
         0.30f, 0.0f, 0.0f,    // left2
         0.50f, 0.00f, 0.0f,  // right2
         0.75f, 0.50f, 0.0f   // top2
    };
